...
def report_landing():
    ...
    if request.method == 'POST':
        ...
        df_flight_data.loc[
            df_flight_data.index[existing_row_index], 'Exceptional Event Occurred'] = exceptional_event_bool
    df_flight_data.loc[
        df_flight_data.index[existing_row_index], 'Exceptional Event Details'] = exceptional_event_details
